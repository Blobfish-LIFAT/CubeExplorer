...
import com.olap3.cubeexplorer.model.QfsetForComparison;
    ...
    public void computeSimilarities() {
        ...
        for (int i = 0; i < queryList.size(); i++) {
            for (int j = 0; j < queryList.size(); j++) {
                QueryCompJaccardStructureThresWithSeveralSelectionPerLevel queryComparison
                        = new QueryCompJaccardStructureThresWithSeveralSelectionPerLevel(queryList.get(i).getQfset(), queryList.get(j).getQfset(), alpha, beta, gamma);
