...
import com.olap3.cubeexplorer.Similarity.Query.Similarity;
import com.olap3.cubeexplorer.model.Qfset;
import com.olap3.cubeexplorer.model.julien.Session;
...
public abstract class SessionComparison {
    ...
    public boolean IsEqual(Object q1, Object q2) {
        ...
        similarity = new QueryCompJaccardStructureThresWithSeveralSelectionPerLevel((Qfset) q1, (Qfset) q2, alpha, beta, gamma).computeSimilarity().getSimilarity();
