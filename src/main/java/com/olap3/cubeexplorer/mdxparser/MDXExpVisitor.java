...
public interface MDXExpVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MDXExpParser#validtext}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValidtext(MDXExpParser.ValidtextContext ctx);
	/**
	 * Visit a parse tree produced by {@link MDXExpParser#atom}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAtom(MDXExpParser.AtomContext ctx);
	/**
